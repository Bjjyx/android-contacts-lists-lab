...
public class FilterContactTypeViewModel extends BaseBottomSheetViewModel {
    ...
    private void updateFilterContactTypes() {
        ...
        ArrayList<FilterContactTypeUi> filterContactTypeUis = new ArrayList<>();
        filterContactTypeUis.add(createAllSelectedItem(types));
        for (String type : types){
            filterContactTypeUis.add(createFilterContactType(type));
        }
        filterContactTypesLiveDate.setValue(filterContactTypeUis);
    }
